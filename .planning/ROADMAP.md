...
- [ ] 01-01-PLAN.md — EAGER models: GameObject + CombatLogLine (Assert.Throws characterization, brace/delimiter [Theory], timestamp locale, golden lines)
...
|-------|----------------|--------|-----------|
| 1. Parser Safety Net | 0/3 | Planned | - |
