...
- [ ] 04-01-PLAN.md — PERF-01: offset-tracking splitter + zero-copy `AsMemory` line slices + parse-free `ToString()` count in CombatLog.cs; Wave-0 read/slice + EnumerateLines-parity tests
