...
- [ ] **BUG-05**: Numeric parse paths (`int/long/ulong.Parse`) skip malformed lines instead of throwing — `Threat.cs:14`, `Actor.cs:64,73,93,100,107`, `Value.cs:47`, `GameObject.cs:75,87,95`
