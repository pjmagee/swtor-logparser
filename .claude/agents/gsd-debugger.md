...
<required_reading>
@D:/Projects/pjmagee/swtor-logparser/.claude/gsd-core/references/common-bug-patterns.md
</required_reading>
...
@D:/Projects/pjmagee/swtor-logparser/.claude/gsd-core/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = D:/Projects/pjmagee/swtor-logparser/.claude
                  → checks D:/Projects/pjmagee/swtor-logparser/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = D:/Projects/pjmagee/swtor-logparser/.claude/gsd-core
                  → writes to D:/Projects/pjmagee/swtor-logparser/.claude/gsd-core/hooks/
...
@D:/Projects/pjmagee/swtor-logparser/.claude/gsd-core/references/thinking-models-debug.md
...
- Read @D:/Projects/pjmagee/swtor-logparser/.claude/gsd-core/references/common-bug-patterns.md
