...
<reference>
@D:/Projects/pjmagee/swtor-logparser/.claude/gsd-core/references/user-profiling.md
...
Read the user-profiling reference document at `D:/Projects/pjmagee/swtor-logparser/.claude/gsd-core/references/user-profiling.md` to load:
