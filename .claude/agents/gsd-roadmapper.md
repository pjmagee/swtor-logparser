...
Reference full template: `D:/Projects/pjmagee/swtor-logparser/.claude/gsd-core/templates/roadmap.md`

## STATE.md Structure

Use template from `D:/Projects/pjmagee/swtor-logparser/.claude/gsd-core/templates/state.md`.
