...
Use template from `D:/Projects/pjmagee/swtor-logparser/.claude/gsd-core/templates/UI-SPEC.md`.
...
Read template: `D:/Projects/pjmagee/swtor-logparser/.claude/gsd-core/templates/UI-SPEC.md`
