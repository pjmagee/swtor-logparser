...
- Usage: Reference from command with `@D:/Projects/pjmagee/swtor-logparser/.claude/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to D:/Projects/pjmagee/swtor-logparser/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to D:/Projects/pjmagee/swtor-logparser/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
