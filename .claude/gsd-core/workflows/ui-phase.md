...
```markdown
Read D:/Projects/pjmagee/swtor-logparser/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: D:/Projects/pjmagee/swtor-logparser/.claude/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read D:/Projects/pjmagee/swtor-logparser/.claude/agents/gsd-ui-checker.md for instructions.
