...
```
Agent(
  prompt="Read D:/Projects/pjmagee/swtor-logparser/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `D:/Projects/pjmagee/swtor-logparser/.claude/gsd-core/templates/SECURITY.md`
