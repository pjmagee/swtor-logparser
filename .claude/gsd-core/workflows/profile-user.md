...
Key references:
- @D:/Projects/pjmagee/swtor-logparser/.claude/gsd-core/references/ui-brand.md (display patterns)
- @D:/Projects/pjmagee/swtor-logparser/.claude/agents/gsd-user-profiler.md (profiler agent definition)
- @D:/Projects/pjmagee/swtor-logparser/.claude/gsd-core/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="D:/Projects/pjmagee/swtor-logparser/.claude/gsd-core/USER-PROFILE.md"
...
```bash
cp "D:/Projects/pjmagee/swtor-logparser/.claude/gsd-core/USER-PROFILE.md" "D:/Projects/pjmagee/swtor-logparser/.claude/USER-PROFILE.backup.md"
```
...
✓ Stores profile at D:/Projects/pjmagee/swtor-logparser/.claude/gsd-core/USER-PROFILE.md
...
- The user-profiling reference doc at `D:/Projects/pjmagee/swtor-logparser/.claude/gsd-core/references/user-profiling.md`
...
Reference: @D:/Projects/pjmagee/swtor-logparser/.claude/gsd-core/references/user-profiling.md
...
Display: "✓ Profile written to D:/Projects/pjmagee/swtor-logparser/.claude/gsd-core/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global CLAUDE.md" -- "Add profile to D:/Projects/pjmagee/swtor-logparser/.claude/CLAUDE.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at D:/Projects/pjmagee/swtor-logparser/.claude/gsd-core/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at D:/Projects/pjmagee/swtor-logparser/.claude/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to D:/Projects/pjmagee/swtor-logparser/.claude/CLAUDE.md"
...
```bash
BACKUP_PATH="D:/Projects/pjmagee/swtor-logparser/.claude/USER-PROFILE.backup.md"
```
...
Your profile:    D:/Projects/pjmagee/swtor-logparser/.claude/gsd-core/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   D:/Projects/pjmagee/swtor-logparser/.claude/skills/gsd-dev-preferences/SKILL.md
  ✓ CLAUDE.md section       ./CLAUDE.md
  ✓ Global CLAUDE.md        D:/Projects/pjmagee/swtor-logparser/.claude/CLAUDE.md
```
