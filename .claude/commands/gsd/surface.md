...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `D:/Projects/pjmagee/swtor-logparser/.claude/.gsd-surface.json`
(sibling to `D:/Projects/pjmagee/swtor-logparser/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `D:/Projects/pjmagee/swtor-logparser/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`D:/Projects/pjmagee/swtor-logparser/.claude/skills`).
...
`D:/Projects/pjmagee/swtor-logparser/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `D:/Projects/pjmagee/swtor-logparser/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `D:/Projects/pjmagee/swtor-logparser/.claude/.gsd-surface.json`
Install profile marker: `D:/Projects/pjmagee/swtor-logparser/.claude/.gsd-profile`
Skill dirs: `D:/Projects/pjmagee/swtor-logparser/.claude/skills/gsd-*/`
Engine module: `D:/Projects/pjmagee/swtor-logparser/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `D:/Projects/pjmagee/swtor-logparser/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
